...
class GRUClassifier(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers, num_classes):
        ...
        self.gru = nn.GRU(input_size=input_size, hidden_size=hidden_size, num_layers=num_layers, dropout=0.4, batch_first=True)
...
def main():
    ...
    num_classes = 5
    gru = GRUClassifier(1, 68, 2, num_classes).to(device)

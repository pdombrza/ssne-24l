...
class Generator(nn.Module):
    def __init__(self, latent_dim, output_dim):
        ...
        self.fc_10 = nn.Linear(128, 512)
        self.fc_11 = nn.Linear(512, 1024)
        self.fc_12 = nn.Linear(1024, output_dim)
        self.ReLU = nn.ReLU()
    ...
    def forward(self, x):
        ...
        h = self.ReLU(self.fc_10(h))
        h = self.ReLU(self.fc_11(h))
        x_hat = torch.sigmoid(self.fc_12(h))

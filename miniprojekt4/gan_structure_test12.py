...
class Generator(nn.Module):
    def __init__(self, latent_dim, output_dim):
        ...
        self.fc_1 = nn.Linear(latent_dim, 64)
        self.fc_2 = nn.Linear(64, 128)
        self.fc_3 = nn.Linear(128, 192)
        self.fc_4 = nn.Linear(192, 256)
        self.fc_5 = nn.Linear(256, 512)
        self.fc_6 = nn.Linear(512, 1024)
        self.fc_7 = nn.Linear(1024, 1536)
        self.fc_8 = nn.Linear(1536, output_dim)
        self.ReLU = nn.ReLU()
    ...
    def forward(self, x):
        ...
        x_hat = torch.sigmoid(self.fc_8(h))

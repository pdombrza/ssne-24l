...
def main():
    ...
    classes = 50
    conv_layers = [
        ConvParams(in_channels=3, out_channels=32, conv_kernel_size=5, stride=1, padding=2, pool_kernel_size=2),
        ConvParams(in_channels=32, out_channels=64, conv_kernel_size=5, stride=1, padding=2, pool_kernel_size=2),

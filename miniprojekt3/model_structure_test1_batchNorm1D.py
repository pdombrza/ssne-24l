...
def main():
    ...
    conv_layers = [
        ...
        ConvParams(in_channels=128, out_channels=128, conv_kernel_size=5, stride=1, padding=2, pool=False),
        ...
        ConvParams(in_channels=16, out_channels=16, conv_kernel_size=3, stride=1, padding=0, pool=False),
    ]
    linear_layers = [
        LinearParams(inputs=16*22*22, outputs=1024, dropout=0.5),

...
def main():
    ...
    classes = 50
    conv_layers = [
        ConvParams(in_channels=3, out_channels=64, conv_kernel_size=7, stride=1, padding=3, pool_kernel_size=2),
        ConvParams(in_channels=64, out_channels=128, conv_kernel_size=7, stride=1, padding=0, pool_kernel_size=2),
    ...
    linear_layers = [
        LinearParams(inputs=32*7*7, outputs=1024, dropout=0.5),
